let vue = new Vue({
    ...
    data: {
        macros: [],
        temp: {
            "html": '<div class="col-md-12 temp" id="" style="border: 1px solid #c6c8ca;border-radius: 20px;margin: 10px 0px;padding: 10px 0px;">\n' +
    ...
    methods: {
        create: function() {
            ...
            axios.post('/create-sequence', sequences)
